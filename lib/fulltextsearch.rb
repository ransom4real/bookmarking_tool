# This is an add-on to the ActiveRecord::Base class.  Allows fulltextsearch on models that choose to mix it in
module ActiveRecord
  class Base
    # Allow the user to set the default searchable fields/columns
    ...
    # Return the default set of fields/columns to search on
    ...
    # Search any model in the database for the given parameters:
    #   text = a string to search for
    #   :only => an array of fields in which to search for the text;
    #     default is 'all varchar or string columns'
    ...
    def self.search(text = nil, options = {})
      ...
      # The fields to search (default is all text/varchar fields)
